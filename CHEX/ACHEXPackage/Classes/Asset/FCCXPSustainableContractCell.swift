...
class FCCXPSustainableContractCell: UITableViewCell {
    ...
    @IBOutlet weak var contractBgView: UIView!
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        contractBgView.backgroundColor = COLOR_CellBgColor
        contractBgView.layer.cornerRadius = 10.0
    ...
    var assetModel:FCCXPAssetModel? {
        ...
        self.digitAssetEquityL.textColor = COLOR_TabBarTintColor
