...
/** 背景色 */
public let COLOR_BGColor = COLOR_HexColor(0x101114)//COLOR_HexColor(0x191B20)
...
/** 导航栏背景色 */
public let COLOR_navBgColor = COLOR_HexColor(0x101114)//COLOR_HexColor(0x191B20)
...
public let COLOR_BGRiseColor = COLOR_HexColorAlpha(0x2AB462, alpha: 0.2)
public let COLOR_BGFailColor = COLOR_HexColorAlpha(0xFB4B50, alpha: 0.2)
