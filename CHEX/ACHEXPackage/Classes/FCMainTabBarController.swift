...
class FCMainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let shadowImg = UIImage.at_image(with: COLOR_LineColor, with: CGSize(width:kSCREENWIDTH, height:0.3))
    ...
    func addTabItemViewController(itemViewController:UIViewController,itemTitle:NSString,normalImg:NSString, selectedImg:NSString) -> () {
        ...
        if itemTitle == "交易" {
            tabItem.imageInsets = UIEdgeInsets(top: -14, left: 0, bottom: 14, right: 0)
        }
