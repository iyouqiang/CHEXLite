...
class FCCXPHomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("CNetAddress.netAddresscl().hosturl_SPOT : ", FCNetAddress.netAddresscl().hosturl_SPOT)
        
        /// 数据轮询
        self.refreshSybolData()
        
        /// 界面背景底色
        let bgImgView = UIImageView(image: UIImage(named: "homebackground"))
        ...
        let logoBtn = fc_buttonInit(imgName: "", title: "首页", fontSize: 22, titleColor: .white, bgColor: .clear)
